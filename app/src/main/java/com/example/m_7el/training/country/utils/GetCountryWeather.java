...
public class GetCountryWeather {
    ...
    private static Info weatherInfo;

    public static Info getWeather(CountryInfo mCountryInfo) {
        ...
        call2.enqueue(new Callback<Info>() {
            ...
            @Override
            public void onResponse(@NonNull Call<Info> call, @NonNull final Response<Info> response) {
